...
================================================================================
*/
"use client"; // This component needs to be a client component for the onError handler
    ...
    <>
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="flex gap-2">
          <button className="flex-1 bg-cyan-500 text-black font-bold py-2 px-4 rounded-md text-sm hover:bg-cyan-400 transition-colors">Buy</button>
          <button className="bg-slate-700 text-white py-2 px-3 rounded-md hover:bg-slate-600 transition-colors"><ShoppingCart size={16}/></button>
        </div>
      </div>
    </>
  );
