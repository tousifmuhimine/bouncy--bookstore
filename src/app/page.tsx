            ...
            {[...sections, ...sections].map((sectionName, index) => (
              <div key={index} className="flex-shrink-0 mx-2">
                <Link
                  ...
                  className="w-40 sm:w-48 md:w-64 h-40 bg-slate-800/50 rounded-lg flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-[1.03] hover:shadow-cyan-500/10 shadow-md border border-slate-700 hover:border-cyan-500"
                >
