/*
================================================================================
 FILE: src/app/book/[bookId]/page.tsx (UPDATED FOR NEXT.JS 15 - PRESERVING YOUR ORIGINAL DESIGN)
================================================================================
*/
"use client"; // Needs to be a client component to use the BookImage component
...
// Create a new client component just for the image to handle the onError event
...
export default function BookPage({ params }: BookPageProps) {
  ...
  const book = bookData.flatMap(s => s.books).find(b => b.id === parseInt(bookId));
       ...
       <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="text-white">
             ...
             <div className="flex items-center gap-4">
                <button className="flex-1 bg-gradient-to-r from-cyan-500 to-fuchsia-500 text-white font-bold py-3 px-6 rounded-lg text-lg hover:opacity-90 transition-opacity shadow-lg">Buy Now</button>
                <button className="bg-slate-700 text-white py-3 px-5 rounded-lg hover:bg-slate-600 transition-colors"><ShoppingCart size={24}/></button>
             </div>
          </div>
       </div>
    </div>
